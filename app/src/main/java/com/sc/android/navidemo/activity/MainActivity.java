...
public class MainActivity extends AppCompatActivity implements LocationSource, AMapLocationListener, OnClickListener, RouteSearch.OnRouteSearchListener, AMap.OnCameraChangeListener, AMapNaviListener {
    //基础地图声明
...
//    private int drivingMode = RouteSearch.DrivingDefault;// 驾车默认模式  修改_周科羽
    private int drivingMode =RouteSearch.WalkDefault;//步行默认模式   周
    ...
    private static final int TIME_INTERVAL = 50;//Thread sleep time
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTtsManager = TTSController.getInstance(getApplicationContext());//语音导航功能
        mTtsManager.init();
